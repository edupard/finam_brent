...
for y in range(2016, 2019):
    for m in range(1, 13):
        ...
        fromDate = checkpoint_date - datetime.timedelta(days=120)#dateutil.relativedelta.relativedelta(month=3)
        toDate = checkpoint_date + datetime.timedelta(days=60)#dateutil.relativedelta.relativedelta(month=2)
        # %Y %m %d
